...
class Locality(models.Model):
    ...
    postcode = models.CharField(_('locality'), max_length=15, db_index=True, help_text=_('ZIP/Postal code'))
    suburb = models.CharField(_('locality'), max_length=80, help_text=_('Locality subdivision'))
